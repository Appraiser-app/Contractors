...
const FALLBACK_CLIENT_EMAIL = "firebase-adminsdk-fbsvc@contractors-d5c0d.iam.gserviceaccount.com";
...
function getAdminApp(): App {
  ...
  const storageBucket = process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || "contractors-d5c0d.appspot.com";

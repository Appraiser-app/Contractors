              ...
              <div key={col.key} className={`rounded-2xl border p-4 ${col.color}`}>
                ...
                <div className="space-y-3">
                  {colTasks.map(task => (
                    <div
                      key={task.id}
                      className={`bg-white rounded-xl border p-3.5 shadow-sm hover:shadow-md transition-shadow group ${editingId === task.id ? "ring-2 ring-amber-400" : "border-gray-200"}`}
                    >
                      ...
                      <div className="flex gap-1.5 mt-3 pt-3 border-t border-gray-100">
                        ...
                        {col.key !== "DONE" && (
                          <button
                            ...
                            className="text-[10px] text-amber-600 hover:text-amber-700 hover:bg-amber-50 px-2 py-1 rounded-lg transition-colors mr-auto"
                          >

...
export default function WhatsAppPage() {
  const [activeTab, setActiveTab] = useState<"messages" | "bot">("messages");
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="flex gap-1 bg-gray-100 rounded-2xl p-1 mb-6 w-fit">
        <button
          ...
          className={`px-5 py-2 rounded-xl text-sm font-medium transition-all ${activeTab === "messages" ? "bg-white text-gray-900 shadow-sm" : "text-gray-500 hover:text-gray-700"}`}
        >
        ...
        <button
          ...
          className={`px-5 py-2 rounded-xl text-sm font-medium transition-all ${activeTab === "bot" ? "bg-white text-gray-900 shadow-sm" : "text-gray-500 hover:text-gray-700"}`}
        >
          <span className="flex items-center gap-2">
            🤖 בוט הוצאות
          </span>
      ...
      {activeTab === "bot" && <WhatsAppBot />}

      {activeTab === "messages" && <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 sm:gap-6">

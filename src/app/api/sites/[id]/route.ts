...
export async function PUT(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    const site = await updateSite(id, { name, location: location || null, description: description || null, clientName: clientName || null, contractValue: contractValue || null, status, startDate: startDate || null, endDate: endDate || null });
